...
export default function ImageList({AlbumnPage ,setAlbumnPage}){
    ...
    function handleBackClick(e){
        e.preventDefault();
        setAlbumnPage({albumnId : "", open : true});
    }

    // get all the images from database 
    useEffect(()=>{
        onSnapshot(doc(db, "Albumn",AlbumnPage.albumnId), (doc) => {
    ...
    async function handleImageDelete(image){
        const albumRef = doc(db, 'Albumn', AlbumnPage.albumId);
    ...
    return(
        <>
            ...
            <div style={{textAlign:"center"}}>
                {showImageForm && <ImageForm albumId={AlbumnPage.albumnId} 
            ...
            <div className={styles.imageList}>
                ...
                }).map((image,i) => <Image image={image.link} 
                                                key={i}
                                                index={i}
